...
class LegoApi {
  ...
  Future<dynamic> colorsRead(String id, {String? ordering}) async {
    return _apiClient.get('/api/v3/lego/colors/$id/', queryParameters: {'ordering': ordering});
  }

  Future<dynamic> elementsRead(String elementId) async {
    return _apiClient.get('/api/v3/lego/elements/$elementId/');
  }
  ...
  Future<dynamic> minifigsRead(String setNum) async {
    return _apiClient.get('/api/v3/lego/minifigs/$setNum/');
  }
  ...
  Future<dynamic> partsRead(String partNum) async {
    return _apiClient.get('/api/v3/lego/parts/$partNum/');
  }
  ...
  Future<dynamic> setsRead(String setNum) async {
    return _apiClient.get('/api/v3/lego/sets/$setNum/');
  }
}
